...
struct AddressBook {
    int _address_len;
    char _address[MAX_STRING_LENGTH];
    signed long _number;
};
...
#define MAX_Person_SIZE 19247

/* Structure that holds a deserialized Person-message. */
struct Person {
    struct AddressBook _ab;
    int _name1_len;
    char _name1[MAX_STRING_LENGTH];
    int _name2_len;
    char _name2[MAX_STRING_LENGTH];
    int _name3_len;
    char _name3[MAX_STRING_LENGTH];
    int _name4_len;
    char _name4[MAX_STRING_LENGTH];
    int _name5_len;
    char _name5[MAX_STRING_LENGTH];
    int _name6_len;
    char _name6[MAX_STRING_LENGTH];
    int _bname_len;
    char _bname[MAX_BYTES_LENGTH];
    signed long _id;
    ...
    int _strAttr_len[MAX_REPEATED_LENGTH];
    char _strAttr[MAX_REPEATED_LENGTH][MAX_STRING_LENGTH];
    int _bAttr_repeated_len;
    int _bAttr_len[MAX_REPEATED_LENGTH];
    char _bAttr[MAX_REPEATED_LENGTH][MAX_BYTES_LENGTH];
    int _intAttr_repeated_len;
    signed long _intAttr[MAX_REPEATED_LENGTH];
    int _int64Attr_repeated_len;
    signed long long _int64Attr[MAX_REPEATED_LENGTH];
    int _sintAttr_repeated_len;
    signed long _sintAttr[MAX_REPEATED_LENGTH];
    int _sintAttr64_repeated_len;
    signed long long _sintAttr64[MAX_REPEATED_LENGTH];
    int _uintAttr_repeated_len;
    unsigned long _uintAttr[MAX_REPEATED_LENGTH];
    int _uintAttr64_repeated_len;
    unsigned long long _uintAttr64[MAX_REPEATED_LENGTH];
    int _fintAttr_repeated_len;
    unsigned long _fintAttr[MAX_REPEATED_LENGTH];
    int _fintAttr64_repeated_len;
    unsigned long long _fintAttr64[MAX_REPEATED_LENGTH];
    int _sfintAttr_repeated_len;
    signed long _sfintAttr[MAX_REPEATED_LENGTH];
    int _sfintAttr64_repeated_len;
    signed long long _sfintAttr64[MAX_REPEATED_LENGTH];
    int _boolAttr_repeated_len;
    char _boolAttr[MAX_REPEATED_LENGTH];
    int _floatAttr_repeated_len;
    float _floatAttr[MAX_REPEATED_LENGTH];
    int _doubleAttr_repeated_len;
    double _doubleAttr[MAX_REPEATED_LENGTH];
    int _enumAttr_repeated_len;
    enum PhoneType _enumAttr[MAX_REPEATED_LENGTH];
    ...
    int _optString_len;
    char _optString[MAX_STRING_LENGTH];
    int _optBytes_len;
    char _optBytes[MAX_BYTES_LENGTH];
